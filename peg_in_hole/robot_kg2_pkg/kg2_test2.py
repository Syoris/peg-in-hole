...
def test_kg2():
    try:
        ...
        if init_result != ErrorCode.NO_ERROR_KINOVA:
            raise RuntimeError(f"Error initializing the API: {init_result.name} (code: {init_result.value})")
        ...
        while True:
            ...
            print(f"Angular Position, Joint 6: {kg2_angular_pos.Actuators.Actuator6} deg")
